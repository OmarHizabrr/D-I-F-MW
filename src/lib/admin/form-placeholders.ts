...
export const FORM_HINTS = {
  project: {
    donorPrimary:
      "المتبرع الرئيسي: يتابع في /portal عبر Google (مفضّل) أو برقم المشروع / اسم المستخدم",
    additionalDonors:
  ...
  donor: {
    ...
    googleSignIn:
      "الطريقة المفضّلة: المتبرع يسجّل عبر Google في /portal — يُربط تلقائياً إذا كان البريد مطابقاً",
    emailMatch:
      "يجب أن يطابق بريد Google البريد المسجّل هنا — عند أول دخول يُربط الحساب ويُضاف لفريق المشروع",
    portalUsername: "طريقة بديلة: الدخول باسم المستخدم والرمز (للمتبرعين بدون Google)",
    linkedUser: "يُملأ تلقائياً عند دخول المتبرع عبر Google، أو يدوياً لربط فريق المشروع",
  },
} as const;
