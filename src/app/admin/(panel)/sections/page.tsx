...
const sectionGroups: { title: string; keys: (keyof SectionTitles)[] }[] = [
  ...
  {
    title: "شارات الثقة (الصفحة الرئيسية)",
    keys: [
      "trustTitle",
      "trustBadge1",
      "trustBadge1Desc",
  ...
  {
    title: "صفحات الشفافية والتبرع والخصوصية",
    keys: [
      "transparencyPageTitle",
      "transparencyPageSubtitle",
      "waysToGivePageTitle",
      "waysToGivePageSubtitle",
      "privacyPageTitle",
      "privacyPageSubtitle",
    ],
  },
  {
    title: "تسميات القائمة المنسدلة",
    keys: [
      "navFaq",
      "navOurWork",
      "navSuccessStories",
  ...
  },
  {
    ...
    keys: [
      ...
      "contactMapsLink",
      "shareStory",
      "successStoriesPageTitle",
      "successStoriesPageSubtitle",
      "faqPageTitle",
      "faqPageSubtitle",
      "eventsPageTitle",
      "eventsPageSubtitle",
      "volunteerPageTitle",
      "volunteerPageSubtitle",
      "ourWorkPageTitle",
      "ourWorkPageSubtitle",
      "resourcesPageTitle",
      "resourcesPageSubtitle",
      "navTeam",
      "navAllProjects",
      "navAboutOverview",
      "viewAll",
...
const fieldLabels: Partial<Record<keyof SectionTitles, string>> = {
  ...
  viewAll: "زر عرض الكل",
  trustTitle: "شارات الثقة — العنوان",
  trustBadge1: "شارة 1 — العنوان",
  trustBadge1Desc: "شارة 1 — الوصف",
  trustBadge2: "شارة 2 — العنوان",
  trustBadge2Desc: "شارة 2 — الوصف",
  trustBadge3: "شارة 3 — العنوان",
  trustBadge3Desc: "شارة 3 — الوصف",
  trustBadge4: "شارة 4 — العنوان",
  trustBadge4Desc: "شارة 4 — الوصف",
  transparencyPageTitle: "صفحة الشفافية — العنوان",
  transparencyPageSubtitle: "صفحة الشفافية — الوصف",
  waysToGivePageTitle: "صفحة طرق التبرع — العنوان",
  waysToGivePageSubtitle: "صفحة طرق التبرع — الوصف",
  privacyPageTitle: "صفحة الخصوصية — العنوان",
  privacyPageSubtitle: "صفحة الخصوصية — الوصف",
  navFaq: "القائمة — الأسئلة الشائعة",
  navOurWork: "القائمة — أعمالنا",
  navSuccessStories: "القائمة — قصص النجاح",
  navStories: "القائمة — قصصنا",
  navNews: "القائمة — الأخبار",
  navEvents: "القائمة — الفعاليات",
  navMedia: "القائمة — الوسائط",
  navVolunteer: "القائمة — التطوع",
  navContact: "القائمة — التواصل",
  navShareStory: "القائمة — شارك قصتك",
  navResources: "القائمة — الموارد",
  navTransparency: "القائمة — الشفافية",
  navZakatCalculator: "القائمة — حاسبة الزكاة",
  navWaysToGive: "القائمة — طرق التبرع",
  navPrivacy: "القائمة — الخصوصية",
};
