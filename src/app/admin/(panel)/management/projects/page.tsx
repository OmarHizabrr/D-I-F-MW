  ...
  return (
    <div>
      ...
      <AdminFlowGuide
        ...
        steps={[
          "إنشاء متبرع من «المتبرعون» وتفعيل البوابة",
          "ربط متبرع رئيسي بالمشروع هنا أو من تفاصيل المشروع",
          "المتبرع يدخل /portal برقم المشروع أو اسم المستخدم والرمز",
          "فريق العمل يُضاف من تبويب «الأعضاء» داخل المشروع",
          "الزوار يرون المشروع على /projects عند تفعيل «نشر على الموقع»",
        ]}
      />
